...
class QLearningAgent:
    ...
    def save_outputs(self, label="hybrid_rl_lightgbm_dynamic"):
        base_path = "Phase-III\ESMR\Output_training"
...
if __name__ == "__main__":
    ...
    causal_top_parents = load_top_causal_parents(causal_csv_path, top_k=3)
    ...
    agent.save_outputs(label="hybrid_rl_lightgbm_dynamic")
